// const { createElement } = require('../lib'); // original
import { createElement } from '../lib'; // my edit

// class TodoForm { // original
export default class TodoForm { // my edit
...
// module.exports = TodoForm; // original
