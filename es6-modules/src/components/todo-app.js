// const { createElement, noop } = require('../lib'); // original
// const TodoList = require('./todo-list'); // original
// const TodoForm = require('./todo-form'); // original
import TodoForm from './todo-form'; // my edit
import TodoList from './todo-list'; // my edit
import { createElement, noop } from '../lib/'; // my edit

// class TodoApp { // original
export default class TodoApp { // my edit
...
// module.exports = TodoApp; // original
